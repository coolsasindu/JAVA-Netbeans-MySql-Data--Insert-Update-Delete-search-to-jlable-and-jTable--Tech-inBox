  ...
  public void tbload(){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String tp =  c_tp.getText();   
        ...
        Statement s = db.mycon().createStatement();
       s.executeUpdate(" INSERT INTO employee(employee_Name,employee_TP) VALUES ('"+name+"','"+tp+"')");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                c_name.setText(rs.getString("employee_Name")); // Customer_Name 	Customer_TP 
                c_tp.setText(rs.getString("employee_TP"));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String id = c_search.getText();
        ...
        try {
            ...
            s.executeUpdate(" UPDATE employee SET employee_Name='"+name+"',employee_TP = '"+tp+"' WHERE eid ='"+id+"'  ");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            Statement s = db.mycon().createStatement();
            s.executeUpdate(" DELETE FROM employee WHERE eid ='"+c_search.getText()+"' ");
