  ...
  public void tbload(){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String tp =  c_tp.getText();   
        ...
        Statement s = db.mycon().createStatement();
       s.executeUpdate(" INSERT INTO customers(Customer_Name,Customer_TP ) VALUES ('"+name+"','"+tp+"')");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Statement s = db.mycon().createStatement();
            ResultSet rs = s.executeQuery(" SELECT * FROM customers WHERE cid = '"+id+"'");
            
            if (rs.next()) {
                
                c_name.setText(rs.getString("Customer_Name")); // Customer_Name 	Customer_TP 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String id = c_search.getText();
        ...
        try {
            ...
            s.executeUpdate(" UPDATE customers SET Customer_Name='"+name+"',Customer_TP = '"+tp+"' WHERE cid ='"+id+"'  ");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            Statement s = db.mycon().createStatement();
            s.executeUpdate(" DELETE FROM customers WHERE cid ='"+c_search.getText()+"' ");
